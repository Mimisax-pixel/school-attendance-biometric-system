...
const StudentLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      setSubmit(true);
      const res = await api.post("/login/student", loginDetails);
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-700">
              If you're a staff member or administrator, please use the{" "}
              <Link to="/staff/login" className="font-semibold hover:underline">
                Staff Portal
              </Link>
              .
            </p>
