      ...
      >
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          {[
            {
              name: "Dashboard",
              icon: "M3 11.5L12 4l9 7.5v7a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-7z",
            },
            {
              name: "Attendance",
              icon: "M8 7V3m8 4V3M3 11h18M5 21h14a2 2 0 0 0 2-2V8H3v11a2 2 0 0 0 2 2z",
            },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 md:py-10 relative z-20">
          <div className="pb-6">
            ...
            <p className="text-gray-500 mt-2 text-sm md:text-base">
              Configure automated alerts for attendance, performance, and
              deadlines.
            </p>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-8">
            {[
              ...
              <section
                key={i}
                className="bg-white rounded-lg shadow-sm p-6 sm:p-8 relative z-30"
              >
